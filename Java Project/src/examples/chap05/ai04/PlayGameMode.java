...
import examples.chap05.ai04.ai.AI;
import examples.chap05.ai04.ai.CommandsLister;
import examples.chap05.ai04.ai.DefaultCommandsLister;
import examples.chap05.ai04.ai.ExplorationAI;
import examples.chap05.ai04.ai.TrackAI;
import examples.chap05.ai04.ai.mapproviders.DistanceMapProvider;
import examples.chap05.ai04.ai.mapproviders.CharMapMaintainer;
import examples.chap05.ai04.gui.Keyboard;
...
import examples.chap05.ai04.render.Renderer;
import examples.chap05.ai04.rules.commands.DirectionCommand;
import examples.chap05.ai04.rules.Rules;
...
import examples.chap05.ai04.state.immutable.ImmutableState;
import examples.chap05.ai04.state.mutable.MutableState;
...
public class PlayGameMode extends GameMode {
    ...
    public void init() 
    {
        ...
        for(int charIndex=1;charIndex<5;charIndex++) {
            ais[charIndex] = new TrackAI("Pacman",imState,charIndex,commandsLister,random);
            ais[charIndex].setDmProvider(dmProvider);
        }
    ...
    public void handleInputs() {
        ...
        switch(keyboard.getLastPressedKey()) {
            ...
            case KeyEvent.VK_F8:
                ...
                renderer.setDistanceMap(dmProvider.getMap("Pacman"));
                break;
