...
package examples.chap06.threads01;

import examples.chap06.threads01.sync.RulesThreadObserver;
import examples.chap06.threads01.sync.RulesThread;
import examples.chap06.threads01.ai.AI;
import examples.chap06.threads01.ai.CommandsLister;
import examples.chap06.threads01.ai.DefaultCommandsLister;
import examples.chap06.threads01.ai.GhostAI;
import examples.chap06.threads01.ai.MinimaxAI;
import examples.chap06.threads01.ai.mapproviders.DistanceMapProvider;
import examples.chap06.threads01.ai.mapproviders.GhostsMapMaintainer;
import examples.chap06.threads01.ai.mapproviders.CharMapMaintainer;
import examples.chap06.threads01.ai.mapproviders.GraveyardMapMaintainer;
import examples.chap06.threads01.ai.mapproviders.GumsMapMaintainer;
...
import examples.chap06.threads01.render.Renderer;
import examples.chap06.threads01.rules.commands.DirectionCommand;
...
import examples.chap06.threads01.state.immutable.ImmutableState;
import examples.chap06.threads01.state.mutable.MutableState;
import examples.chap06.threads01.sync.CachedStateObverser;
...
public class PlayGameMode extends GameMode implements RulesThreadObserver {
    ...
    public void initAI(MutableState state) 
    {
        ...
        ais[0] = new MinimaxAI(imState,commandsLister,random,dmProvider);
