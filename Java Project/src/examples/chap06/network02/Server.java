...
import examples.chap06.network02.server.PlayerService;
import examples.chap06.network02.server.ServiceException;
import examples.chap06.network02.server.ServiceManager;
import examples.chap06.network02.server.ServiceQuery;
import examples.chap06.network02.server.VersionService;
...
public class Server implements HttpHandler {
    ...
    public Server() {
        ...
        serviceManager.registerService("/player", new PlayerService(jsonBuilderFactory));
    }
