...
package examples.chap06.network02.state.mutable;

import examples.chap06.network02.state.ElementFactory;
import examples.chap06.network02.state.Direction;
import examples.chap06.network02.state.Space;
import examples.chap06.network02.state.SpaceTypeId;
import examples.chap06.network02.state.StaticElement;
import examples.chap06.network02.state.Wall;
import examples.chap06.network02.state.WallTypeId;
