...
import examples.chap06.network02.state.mutable.MutableElement;
import examples.chap06.network02.state.mutable.MutableSpace;
import examples.chap06.network02.state.mutable.MutableWall;
