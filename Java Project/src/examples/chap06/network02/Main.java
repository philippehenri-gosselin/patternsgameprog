...
import examples.chap06.network02.gui.GUIFacade;
import examples.chap06.network02.gui.awt.AWTGUIFacade;
import examples.chap06.network02.menu.LobbyMenu;
import examples.chap06.network02.menu.MainMenu;
import examples.chap06.network02.menu.MultiplayerMenu;
import examples.chap06.network02.mt.TaskManager;
...
//        pacman.setGameMode(new MainMenu());
        pacman.setGameMode(new MultiplayerMenu());
        pacman.run();
