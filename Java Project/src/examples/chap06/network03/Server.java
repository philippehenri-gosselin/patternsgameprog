...
import examples.chap06.network03.server.CommandService;
import examples.chap06.network03.server.Game;
import examples.chap06.network03.server.GameService;
import examples.chap06.network03.server.PlayerService;
import examples.chap06.network03.server.ServiceException;
import examples.chap06.network03.server.ServiceManager;
import examples.chap06.network03.server.ServiceQuery;
import examples.chap06.network03.server.VersionService;
...
public class Server implements HttpHandler {
    ...
    public Server() {
        ...
        serviceManager.registerService("/version", new VersionService(jsonBuilderFactory));
        serviceManager.registerService("/player", new PlayerService(jsonBuilderFactory,game));
        serviceManager.registerService("/game", new GameService(jsonBuilderFactory,game));
        serviceManager.registerService("/command", new CommandService(jsonBuilderFactory,game));
    }
