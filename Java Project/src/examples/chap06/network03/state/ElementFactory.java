...
import examples.chap06.network03.state.Element;
import examples.chap06.network03.state.SpaceTypeId;
import examples.chap06.network03.state.WallTypeId;
import examples.chap06.network03.state.mutable.MutableElement;
import examples.chap06.network03.state.mutable.MutableSpace;
import examples.chap06.network03.state.mutable.MutableWall;
