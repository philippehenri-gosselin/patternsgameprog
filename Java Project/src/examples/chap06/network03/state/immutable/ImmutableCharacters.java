...
import examples.chap06.network03.state.mutable.MutableCharacters;
import examples.chap06.network03.state.mutable.MutableGhost;
import examples.chap06.network03.state.mutable.MutablePacman;
