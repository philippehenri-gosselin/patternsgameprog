...
import examples.chap04.command04.state.*;
import examples.chap04.command04.rules.actions.Action;
import examples.chap04.command04.rules.actions.EnableSuperAction;
import examples.chap04.command04.rules.actions.GumAction;
